...
from aioviber2.dispatcher.filters.filters import BoundFilter, Filter
from aioviber2.types import CallbackQuery, Message
from aioviber2.types import KeyboardButton, InlineKeyboardButton
...
class StateFilter(BoundFilter):
    ...
    def __init__(self, dispatcher, state):
        from aioviber2.dispatcher.filters.state import State, StatesGroup
        from aioviber2 import Dispatcher
