...
from viber import Dispatcher, types
from viber.dispatcher.handler import SkipHandler
from viber.types import ReplyKeyboardMarkup, InlineKeyboardMarkup
...
async def check_pinning_availability(channel_id: int = None):
    ...
    return api0.check_pinning_availability(channel_id)
